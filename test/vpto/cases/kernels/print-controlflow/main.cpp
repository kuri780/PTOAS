...
void LaunchPrint_controlflow_kernel_mix_aiv(float *v1, float *v2, int32_t v3, int32_t v4, void *stream);
...
int main() {
    ...
    LaunchPrint_controlflow_kernel_mix_aiv(v1Device, v2Device, modeHost, nHost, stream);
