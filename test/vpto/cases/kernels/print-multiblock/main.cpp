...
void LaunchPrint_multiblock_kernel_mix_aiv(float *v1, float *v2, int32_t v3, void *stream);
...
int main() {
    ...
    LaunchPrint_multiblock_kernel_mix_aiv(v1Device, v2Device, nHost, stream);
