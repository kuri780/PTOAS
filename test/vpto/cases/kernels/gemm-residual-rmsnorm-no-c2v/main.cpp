...
void LaunchGemm_residual_rmsnorm_no_c2v_kernel(
...
int main() {
  ...
  constexpr size_t gemmGmElem = kM * kN;
  ...
  constexpr size_t gemmGmSize = gemmGmElem * sizeof(float);
  ...
  float *gemmGmDev0 = nullptr;
  float *gemmGmDev1 = nullptr;
  ...
  ACL_CHECK(aclrtMalloc((void **)&gemmGmDevice, gemmGmSize, ACL_MEM_MALLOC_HUGE_FIRST));
  ...
  gemmGmDev0 = gemmGmDevice;
  gemmGmDev1 = gemmGmDevice + kRowsPerSb * kN;
  residualDev0 = residualDevice;
  residualDev1 = residualDevice + kRowsPerSb * kN;
  outDev0 = outDevice;
  outDev1 = outDevice + kRowsPerSb * kN;

  LaunchGemm_residual_rmsnorm_no_c2v_kernel(
      aDevice, bDevice, gemmGmDev0, gemmGmDev1,
      residualDev0, residualDev1, gammaDevice,
