...
# case: kernels/gemm-residual-rmsnorm-no-c2v (unfused baseline)
# family: gemm-residual
# shapes: A[16,64] B[64,256] Residual[16,256] Gamma[256] Output[16,256]
# Golden identical to fused version (gemm-residual-rmsnorm-c2v-split-m).
...
def generate(output_dir: Path) -> None:
    # Deterministic but diverse patterns (same as fused version)
